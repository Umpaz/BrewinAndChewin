...
public class ItemMatBlockEntity extends SyncedBlockEntity
{
    ...
    public ItemMatBlockEntity(BlockPos pos, BlockState state) {
        super(BCBlockEntityTypes.ITEM_MAT.get(), pos, state);
    ...
    /*public boolean processStoredItemUsingTool(ItemStack toolStack, @Nullable Player player) {
        ...
        matchingRecipe.ifPresent(recipe -> {
            ...
            for (ItemStack resultStack : results) {
                Direction direction = getBlockState().getValue(ItemMatBlock.FACING).getCounterClockWise();
